...
import 'package:comuno/main.dart';
...
class _ComunoProfileScreenState extends State<ComunoProfileScreen> {
  ...
  Color _overviewColor = Colors.blue;
...
//          elevation: 1,
//          centerTitle: true,
//          title: SizedBox(height: 35.0, child: Image.asset("assets/comuno_logo.png")),
//          actions: <Widget>[
//            new Padding(
//                padding: EdgeInsets.only(right: 0),
//              child: IconButton(
...
//                              child: Text(
//                                "Overview",
//                                style: TextStyle(color: _overviewColor),
//                              ),
//                              onTap: () {
//                                setState(() {
...
//                                    return Text(
//                                      "Posts",
//                                      style: TextStyle(color: _postColor),
//                                    );
//                                  } else {
//                                    return Center(
//                                      child: CircularProgressIndicator(),
...
//                              child: Text(
//                                "Communities",
//                                style: TextStyle(color: _communitiesColor),
//                              ),
//                              onTap: () {
//                                setState(() {
//                                  _isOverviewActive = false;
