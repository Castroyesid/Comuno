...
class ComunoFriendProfileScreen extends StatefulWidget {
  final String name;
  ComunoFriendProfileScreen({this.name});

  @override
  _ComunoFriendProfileScreenState createState() =>
      _ComunoFriendProfileScreenState();
}

class _ComunoFriendProfileScreenState extends State<ComunoFriendProfileScreen> {
